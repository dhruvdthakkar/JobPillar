...
require("./models/User");
const Layofff = require("./models/layoff");
...
connection.once('open', function () {
    ...
    connection.db.collection("layofff", function(err, collection){
...
app.post("/results", (req, res) => {
  var add = [];
  for(var i = 0; i < layoffData.length; i++){
    if(req.body.name == layoffData[i].Sectors){
      add.push(layoffData[i]);
      console.log(layoffData[i]);
    }
  }
  console.log(add);
